...
public class ImageLoader {
	...
	LoadingCache<String, BufferedImage> imagesBufferedCache = CacheBuilder.newBuilder().maximumSize(100)
	...
	public VolatileImage createVolatileFromBuffered(BufferedImage imageB) {
		...
		// now we have a volatile image assigned, draw the buffered image onto
		// it

		Graphics2D g = null;
		try {
			g = imageV.createGraphics();
			// to handle transparancy, clear to transparent instead of default
			// white
